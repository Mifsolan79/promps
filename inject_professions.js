...
// Encontrar el final del objeto window.PROMPT_DATABASE (antes de la llave de cierre final)
const professionData = ',\n    "PROFESIONES": ' + JSON.stringify(data, null, 4);
content = content.replace(/};\s*$/, professionData + '\n};');

fs.writeFileSync(filePath, content);
console.log('Inyectados 100 prompts en la categoría PROFESIONES.');
